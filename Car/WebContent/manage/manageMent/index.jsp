...
<html>
  <head>
    <title>xx后台管理 1.0 - Dashboard</title>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> 汽车管理 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
					  <li>
                        <a href="validation-elements.html">
                          <i class="fa fa-caret-right"></i> 车辆类型管理
                        </a>
                      </li>
                      <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i> 车辆品牌管理
                        </a>
                      </li>
					  <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i> 车辆型号管理
                        </a>
                      </li>
                      <li>
					  ...
					  <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i> 车辆颜色管理
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <a href="buttons.html">
                      <i class="fa fa-tint"></i> 会员管理
                    </a>
                  </li>
                  <li>
                    <a href="grid.html">
                      <i class="fa fa-th"></i> 财务管理
                    </a>
                  </li>

                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-th-large"></i> 员工管理 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="tables.html">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-desktop"></i> 清除数据库 <b class="fa fa-plus dropdown-plus"></b>
