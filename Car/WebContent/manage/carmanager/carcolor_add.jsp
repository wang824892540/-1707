      ...
      <section class="tile color transparent-white">
        ...
        <div class="tile-body" id="titleBody">
          ...
          <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/CarColorServlet">
            ...
            <div class="form-group">
              <label for="colorRemark" class="col-sm-4 control-label">颜色备注：</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="colorRemark" name="colorRemark">
              </div>
            </div>
